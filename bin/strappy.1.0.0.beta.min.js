...
if(Object.isUndefined(window.strappy.$components))window.strappy.$components={};Object.isUndefined(window.strappy.$components[this.my.name])&&(window.strappy.$components[this.my.name]=[]);this.my.index=window.strappy.$components[this.my.name].push(this);this.my.NSObject=window;for(var a=0,b=this.my.namespace.length;a<b;a++)this.my.NSObject=this.my.NSObject[this.my.namespace[a]];this.initRadioTower();this.initStateMgr();this.initViewCache();this.generateInstanceID();$JSKK.when(this.isConfigured.bind(this)).isTrue(function(){this.generateInstanceID();
this.insertBaseContainer();this.initChildComponents();this.initStores();this.initViews();this.initControllers();this.fireEvent("onAfterInit",this)}.bind(this));Object.isFunction(this.initCmp)&&this.initCmp();this.readyForConfig=true},initRadioTower:function(){if(Object.isUndefined(window.strappy.$radioTower))window.strappy.$radioTower=new strappy.RadioTower;this.radioTower=window.strappy.$radioTower},initStateMgr:function(){if(Object.isUndefined(window.strappy.$stateMgr))window.strappy.$stateMgr=
new strappy.StateMgr;this.stateMgr=window.strappy.$stateMgr},initViewCache:function(){if(Object.isUndefined(window.strappy.$viewCache))window.strappy.$viewCache=new strappy.mvc.ViewCache;this.viewCache=window.strappy.$viewCache},getViewCache:function(){return this.viewCache},getBrowser:function(){if(Object.isNull(this.browser.name)){if(Object.isDefined(jQuery.browser.msie))this.browser.name="ie";else if(Object.isDefined(jQuery.browser.webkit))this.browser.name="webkit";else if(Object.isDefined(jQuery.browser.opera))this.browser.name=
