$JSKK.Class.create({$namespace:"strappy",$name:"Component",$uses:[$JSKK.trait.Observable]})({initQueue:function(a,b){console.warn("use of strappy.Component.initQueue is deprecated. Use strappy.InitQueue instead.");var c=$JSKK.toArray(arguments);Object.isDefined(c[1])&&(Object.isFunction(c.last())&&(b=c.pop()),a=c);var d=-1,e=null,f=function(){d++;Object.isUndefined(a[d])?Object.isFunction(b)&&b():Object.isArray(a[d])?(e=Object.isFunction(a[d][0].$reflect)?a[d][0]:new a[d][0],Object.isAssocArray(a[d][1])?
e.observeOnce("onAfterInit",function(){e.getController("State").observeOnce("onReadyState",function(){f()})}.bind(this,d)):f(),e.configure(a[d][1])):(Object.isAssocArray(a[d])||new a[d],f())};f()}},{events:{onConfigured:true,onAfterInit:true},config:{attachTo:null},browser:{name:null,version:null},components:{},stores:[],views:[],controllers:[],_stores:{},_views:{},_controllers:{},_configured:false,my:{name:null,index:null,NSObject:null},radioTower:null,stateMgr:null,viewCache:null,readyForConfig:false,
_iid:null,init:function(){this.my.name=this.$reflect("name");this.my.namespace=this.$reflect("namespace").split(".");if(Object.isUndefined(window.strappy.$components))window.strappy.$components={};Object.isUndefined(window.strappy.$components[this.my.name])&&(window.strappy.$components[this.my.name]=[]);this.my.index=window.strappy.$components[this.my.name].push(this);this.my.NSObject=window;for(var a=0,b=this.my.namespace.length;a<b;a++)this.my.NSObject=this.my.NSObject[this.my.namespace[a]];this.initRadioTower();
this.initStateMgr();this.initViewCache();this.generateInstanceID();$JSKK.when(this.isConfigured.bind(this)).isTrue(function(){this.generateInstanceID();this.insertBaseContainer();this.initChildComponents();this.initStores();this.initViews();this.initControllers();this.fireEvent("onAfterInit",this)}.bind(this));Object.isFunction(this.initCmp)&&this.initCmp();this.readyForConfig=true},initRadioTower:function(){if(Object.isUndefined(window.strappy.$radioTower))window.strappy.$radioTower=new strappy.RadioTower;
this.radioTower=window.strappy.$radioTower},initStateMgr:function(){if(Object.isUndefined(window.strappy.$stateMgr))window.strappy.$stateMgr=new strappy.StateMgr;this.stateMgr=window.strappy.$stateMgr},initViewCache:function(){if(Object.isUndefined(window.strappy.$viewCache))window.strappy.$viewCache=new strappy.mvc.ViewCache;this.viewCache=window.strappy.$viewCache},getViewCache:function(){return this.viewCache},getBrowser:function(){if(Object.isNull(this.browser.name)){if(Object.isDefined(jQuery.browser.msie))this.browser.name=
"ie";else if(Object.isDefined(jQuery.browser.webkit))this.browser.name="webkit";else if(Object.isDefined(jQuery.browser.opera))this.browser.name="opera";else if(Object.isDefined(jQuery.browser.mozilla))this.browser.name="mozilla";this.browser.version=jQuery.browser.version.split(".")[0]}},initChildComponents:function(){var a=null,b=null,c;for(c in this.components){a=this.components[c].split(".");b=window[a[0]];if(Object.isDefined(b))for(var d=1,e=a.length;d<e;d++)if(Object.isDefined(b[a[d]]))b=b[a[d]];
...
function(){this.sendSignal(strappy.Signal.COMPONENT_IS_READY,"component",{origin:this.getIID()},this)}.bind(this));for(var a=0,b=this.controllers.length;a<b;a++)if(Object.isDefined(this.my.NSObject[this.my.name.lowerFirst()].controller[this.controllers[a]]))this._controllers[this.controllers[a]]=new (this.my.NSObject[this.my.name.lowerFirst()].controller[this.controllers[a]])(this);else throw Error('Error controller "'+this.controllers[a]+'" not loaded on component "'+this.my.name+'".');}else throw Error('State controller has not been loaded for component "'+
this.my.name+'". A component MUST have a state store and controller.');},getController:function(a){if(Object.isDefined(this._controllers[a]))return this._controllers[a];else throw Error('Error - controller "'+a+'" has not been initilized on component "'+this.my.name+'".');},initViews:function(){for(var a=0,b=this.views.length;a<b;a++)if(Object.isDefined(this.my.NSObject[this.my.name.lowerFirst()])&&Object.isDefined(this.my.NSObject[this.my.name.lowerFirst()].view)&&Object.isDefined(this.my.NSObject[this.my.name.lowerFirst()].view[this.views[a]]))this._views[this.views[a]]=
new (this.my.NSObject[this.my.name.lowerFirst()].view[this.views[a]])(this);else throw Error('Error - view "'+this.views[a]+'" not loaded on component "'+this.my.name+'".');},getView:function(a){if(Object.isDefined(this._views[a]))return this._views[a];else throw Error('Error - view "'+a+'" has not been initilized on component "'+this.my.name+'".');},initStores:function(){if(Object.isDefined(this.my.NSObject[this.my.name.lowerFirst()].store.State)){this._stores.State=new (this.my.NSObject[this.my.name.lowerFirst()].store.State)(this);
for(var a=0,b=this.stores.length;a<b;a++)if(Object.isDefined(this.my.NSObject[this.my.name.lowerFirst()])&&Object.isDefined(this.my.NSObject[this.my.name.lowerFirst()].store[this.stores[a]]))this._stores[this.stores[a]]=new (this.my.NSObject[this.my.name.lowerFirst()].store[this.stores[a]])(this);else throw Error('Error - store "'+this.stores[a]+'" not loaded for component "'+this.my.name+'".');}else throw Error('State store has not been loaded for component "'+this.my.name+'". A component MUST have a state store and controller.');
},getStore:function(a){if(Object.isDefined(this._stores[a]))return this._stores[a];else throw Error('Error - store "'+a+'" has not been initilized for component "'+this.my.name+'".');},insertBaseContainer:function(){$(this.getConfig("attachTo")||"body")[this.getConfig("attachHow")||"append"](["<div",' class="'+this.$reflect("namespace").replace(/\./g,"-")+"-"+this.$reflect("name")+'-container"',' id="'+this.getIID()+'"',' style="display:none;"></div>'].join(""))},generateInstanceID:function(){for(var a=
"0123456789abcdefghijklmnopqrstuvwxyz".split(""),b=[],c=0;c<8;c++)b.push(a[Math.floor(Math.random()*25)]);this._iid=this.getSafeID()+"-"+b.join("")},getIID:function(){return this._iid},getSafeID:function(){return(this.$reflect("namespace")+"."+this.$reflect("name")).replace(/\./g,"-")},configure:function(a){$JSKK.when(this,"readyForConfig").isTrue(function(){Object.isDefined(this.config)?Object.extend(this.config,a):this.config=a;this._configured=true;this.fireEvent("onConfigured",this);this.sendSignal(strappy.Signal.CMP_DO_RECONFIGURE,
{component:this.my.name})}.bind(this))},reconfigure:function(){$JSKK.when(this,"readyForConfig").isTrue(function(){this.configure(this.config)}.bind(this))},isConfigured:function(){return this._configured},getConfig:function(a){for(var a=a.split("."),b=this.config,c=0,d=a.length;c<d;c++)if(Object.isDefined(b[a[c]]))b=b[a[c]];else return null;return b},getID:function(){var a=[];Object.extend(a,this.namespace);a.push(this.className);return a.join(".")},sendSignal:function(a,b,c,d){if(Object.isEmpty(a))throw Error("Class "+
this.className+" attempted to fire an empty signal.");else $JSKK.when(this,"radioTower").isAssocArray(function(){this.radioTower.fireEvent(a,new strappy.Signal({name:a,body:d,type:b,filter:c}))}.bind(this))}});$JSKK.Class.create({$namespace:"strappy",$name:"InitQueue",$uses:[$JSKK.trait.Observable]})({},{events:{onItemReady:true,onAllReady:true},items:[],processPointer:-1,length:0,complete:0,add:function(a,b,c,d){this.items.push({name:a,ref:b,config:c,callback:d||$JSKK.emptyFunction});this.length++;return this},execute:function(){$JSKK.when(this,{object:"complete",value:this.length}).isEqualTo(function(){this.fireEvent("onAllReady",this.items)}.bind(this));this.processNextItem()},processNextItem:function(){this.processPointer++;
cmp=Object.isFunction(this.items[this.processPointer].ref.$reflect)?this.items[this.processPointer].ref:new this.items[this.processPointer].ref;Object.isAssocArray(this.items[this.processPointer].config)?(cmp.observeOnce("onAfterInit",function(a){a.getController("State").observeOnce("onReadyState",function(){this.fireEvent("onItemReady",this.items[this.processPointer]);++this.complete!=this.length&&this.processNextItem()}.bind(this,this.processPointer))}.bind(this,cmp)),cmp.configure(this.items[this.processPointer].config)):
(this.complete++,this.processNextItem())}});$JSKK.Class.create({$namespace:"strappy",$name:"RadioTower",$uses:[$JSKK.trait.Observable]})({},{events:{}});$JSKK.Class.create({$namespace:"strappy",$name:"SharedState",$extends:strappy.data.stateful.Store})({},{set:function(){if(this.lockState==strappy.data.stateful.Store.LOCK_NONE){var a=$JSKK.toArray(arguments),b={};Object.isDefined(a[1])?b[a.shift()]=a.shift():b=a.shift();for(var c in b)Object.isUndefined(this.record.fields[strappy.data.stateful.Store.ACCESS_PRIVATE][c])&&(this.record.fields[strappy.data.stateful.Store.ACCESS_PRIVATE][c]=null),this.fireEvent("onBeforeChange",this,c,b[c])!==false&&(this.record.record[strappy.data.stateful.Store.ACCESS_PRIVATE][c]=
b[c],this.fireEvent("onChange",this,c,b[c]))}else throw Error('Store "'+this.$reflect("name")+'" is in lock state "'+this.lockState+'" and so cannot be modified.');},get:function(a){return this.record.record[strappy.data.stateful.Store.ACCESS_PRIVATE][a]}});$JSKK.Class.create({$namespace:"strappy",$name:"Signal",$uses:[strappy.trait.signal.Send]})({COMPONENT_IS_READY:"strappy.component.ready",STATE_CHANGE:"strappy.state.change",CMP_DO_RECONFIGURE:"strappy.component.do.reconfigure",SHOW:"strappy.component.show",HIDE:"strappy.component.hide"},{config:{name:null,body:null,type:null,filter:{}},init:function(a){this.config.name=a.name||null;this.config.body=a.body||null;this.config.type=a.type||null;this.config.filter=a.filter||{}},getName:function(){return this.config.name},
getRadioTower:function(){return window.strappy.$radioTower},getBody:function(){return this.config.body},getType:function(){return this.config.type},getFilter:function(){return this.config.filter},isForMe:function(a,b){if(!Object.isNull(a)&&this.getType()!=a)return false;if(!Object.isNull(b)){var c=this.getFilter(),d;for(d in b)if(Object.isUndefined(c[d])||b[d]!=c[d])return false}return true},resend:function(a,b){Object.isUndefined(b)&&(b=this.getBody());if(Object.isUndefined(a.origin)&&Object.isDefined(this.getFilter().origin))a.origin=
this.getFilter().origin;this.sendSignal(this.getName(),this.getType(),a,b);return this}});$JSKK.Class.create({$namespace:"strappy",$name:"StateMgr",$uses:[strappy.trait.signal.Send]})({},{state:{},stateString:"",radioTower:null,sharedState:null,eventSupported:false,supressNext:false,init:function(){this.radioTower=strappy.$radioTower;this.sharedState=new strappy.SharedState;$(window).bind("hashchange",this.onHashChangeTest.bind(this));this.onHashChange(null,true);var a=window.location.hash;window.location.hash="welcome";(function(){window.location.hash=a;this.bindHashEvent.defer(200,this)}).bind(this).defer(100)},
onHashChangeTest:function(){this.eventSupported=true},bindHashEvent:function(){this.eventSupported?$(window).bind("hashchange",this.onHashChange.bind(this)):this.monitorHashChange()},monitorHashChange:function(){$JSKK.when(function(){return window.location.hash.replace("#","")!=this.stateString}.bind(this)).isTrue(function(){this.onHashChange();this.monitorHashChange()}.bind(this))},onHashChange:function(a,b){if(this.supressNext)b=true,this.supressNext=false;this.stateString=window.location.hash.replace("#",
"");this.state=Object.isEmpty(this.stateString)?{}:this.parseStateString(this.stateString);b||this.sendSignal(strappy.Signal.STATE_CHANGE,"state",{},this.state)},registerStateChanger:function(a,b){b=this.parseStateString(b);a.click(this.updateState.bind(this,b,false))},updateState:function(a){var b=[],c;for(c in a)Object.isNull(a[c])&&b.push(c),this.state[c]=a[c];if(b.length){a={};c=0;for(var d=b.length;c<d;c++)a[b[c]]=null;this.sendSignal(strappy.Signal.STATE_CHANGE,"state",{},a)}window.location.hash=
this.parseStateObject(this.state)},getState:function(){return this.state},parseStateString:function(a){for(var a=a.split("&"),b=null,c={},d=0,e=a.length;d<e;d++){b=a[d].split("=");if(["true","false","null"].inArray(b[1]))switch(b[1]){case "true":b[1]=true;break;case "false":b[1]=false;break;case "null":b[1]=null}c[b[0]]=b[1]}return c},parseStateObject:function(){var a=[],b;for(b in this.state)Object.isNull(this.state[b])||a.push(b+"="+this.state[b]);return a.join("&")},getRadioTower:function(){return this.radioTower},
getSharedState:function(){return this.sharedState}});$JSKK.Class.create("Strappy")({VERSION:"1.0.0-beta",VERSION_MAJOR:1,VERSION_MINOR:0,VERSION_MICRO:0,VERSION_STAGE:"beta",VERSION_STAGE_NUM:0},{});$JSKK.Class.create({$namespace:"strappy.data",$name:"AbstractStore",$abstract:true,$uses:[strappy.trait.ComponentConnector,$JSKK.trait.Observable]})({},{events:{onChange:true,onSync:true,onSyncFailed:true,onModelChange:true,onModelLockChange:true},proxy:null,model:null,data:{},record:null,transactions:[],init:function(){if(Object.isNull(this.proxy))this.proxy=new strappy.data.proxy.MemoryProxy},newRecord:function(a){return new this.model({onLockChange:function(a,c){this.fireEvent("onModelLockChange",
...
return this},load:function(a){if(this.proxy&&Object.isFunction(this.proxy.get))this.proxy.get({filter:a,onSuccess:function(a){this.record=this.newRecord(a.data[0]);this.fireEvent("onChange",this,a);this.fireEvent("onLoad",this,a)}.bind(this),onFailure:function(a){this.fireEvent("onLoadFailed",this,a)}.bind(this)});else throw new Exception('The store "'+this.$reflect("namespace")+"."+this.$reflect("name")+'" cannot be synced as it does not have a syncable proxy attached.');return this},isDirty:function(){return this.record.isDirty()}});$JSKK.Class.create({$namespace:"strappy.data",$name:"Transaction"})({STATE_INIT:0,STATE_STARTED:1,STATE_COMITTED:2,STATE_COMPLETE:4,STATE_SUCCESS:8,STATE_FAILED:16,STATE_ROLLEDBACK:32},{models:[],queue:false,state:0,lockState:"full",init:function(a){if(a!==false)this.queue=new strappy.data.Queue},attachModel:function(a){if(Object.isDefined(a)&&Object.isFunction(a.$reflect)&&a.$reflect("extends")==strappy.mvc.Model){var b=a.getStore();b&&b.informModelIsInTransaction(a,this);a.lock(this.lockState);
b=a.clone();a.attachPhantom(b);this.models.push(a);this.queue&&this.queue.attachProxy(a.getStore().getProxy());return b}else throw Error("Transactions can only be used with Models.");},start:function(){this.state|=strappy.data.Transaction.STATE_STARTED;this.fullLock();return this},execute:function(a){var b={total:this.models.length,done:0,fails:0};$JSKK.when(b,{object:"done",value:b.total}).isEqualTo(function(){if(b.fails===0){if(Object.isFunction(a.onSuccess))a.onSuccess()}else if(Object.isFunction(a.onFailure))a.onFailure()}.bind(this));
this.models.each(function(a){var d=a.getPhantom();d.isDirty()&&a.getStore()&&d.bindStore(a.getStore()).sync({onSuccess:function(){b.done++},onFailure:function(){b.done++;b.fails++}}).unbindStore()});this.queue&&this.queue.execute();return this},commit:function(){this.state|=strappy.data.Transaction.STATE_COMITTED;this.models.each(function(a,b){a.lock(strappy.mvc.Model.LOCK_NONE);a.set(a.getPhantom().getRecord());a.destroyPhantom();delete this.models[b]}.bind(this));delete this.models;return this},
rollback:function(){this.state|=strappy.data.Transaction.STATE_ROLLEDBACK;this.models.each(function(a,b){a.destroyPhantom();delete this.models[b]}.bind(this));delete this.models;return this},fullLock:function(){this.lockState="full";this.models.each(function(a){a.lock("full")});return this},readOnly:function(){this.lockState="readonly";this.models.each(function(a){a.lock("readonly")});return this}});$JSKK.Class.create({$namespace:"strappy.data.proxy",$name:"AbstractProxy",$abstract:true,$uses:[$JSKK.trait.Configurable,$JSKK.trait.Observable]})({},{config:{url:""},events:{onBeforeRequest:true},raw:$JSKK.Class.ABSTRACT_METHOD,_onDone:$JSKK.Class.ABSTRACT_METHOD});$JSKK.Class.create({$namespace:"strappy.data.proxy",$name:"Ajax",$extends:strappy.data.proxy.AbstractProxy})({},{get:function(a){a.url=this.config.url;if(this.fireEvent("onBeforeRequest",this,a)!==false){if(Object.isUndefined(a.method))a.method="POST";$.get({type:a.method,url:a.url,data:a.filter||{}}).done(this._onDone.bind(this,a)).fail(a.onFailure||$JSKK.emptyFunction)}},sync:function(a){a.url=this.config.url;this.fireEvent("onBeforeRequest",this,a)!==false&&$.ajax({type:"POST",url:a.url,data:a.data||
{}}).done(this._onDone.bind(this,a)).fail(a.onFailure||$JSKK.emptyFunction)},raw:function(a){console.debug("RAW DATA:",$.stringify(a.data));a.url=this.config.url;this.fireEvent("onBeforeRequest",this,a)!==false&&$.ajax({type:"POST",contentType:"application/json",processData:false,url:a.url,data:$.stringify(a.data)||{}}).done(this._onDone.bind(this,a)).fail(a.onFailure||$JSKK.emptyFunction)},_onDone:function(a,b){b.success?(a.onSuccess||$JSKK.emptyFunction)(b):(a.onFailure||$JSKK.emptyFunction)(b)}});$JSKK.Class.create({$namespace:"strappy.data.proxy",$name:"BTL",$extends:strappy.data.proxy.AbstractProxy})({},{raw:function(a){a.url=this.config.url;this.fireEvent("onBeforeRequest",this,a)!==false&&$.ajax({type:"POST",contentType:"application/json",processData:false,url:a.url,data:$.stringify(a.data)||{}}).done(this._onDone.bind(this,a)).fail(function(){console.warn("BTL Proxies raw() method hasn't been confiugred to deal with failures.")});return this},_onDone:function(a,b){(a.onComplete||$JSKK.emptyFunction)(b)}});$JSKK.Class.create({$namespace:"strappy.data.proxy",$name:"DummyProxy",$extends:strappy.data.proxy.MemoryProxy})({},{defaultResolver:function(a,b){return typeof a.data.id!=="undefined"&&typeof b.id!=="undefined"&&b.id==a.data.id},init:function(){if(!this.config.resolver)this.config.resolver=this.defaultResolver},get:function(a){a.url=this.config.url;this.fireEvent("onBeforeRequest",this,a)!==false&&this.handleRequest({type:a.method,url:a.url,data:a.filter||{}},this._onDone.bind(this,a))},handleRequest:function(a,
b){var c={success:true,data:[]};$.each(this.config.dataSet,function(b,e){this.config.resolver(a,e)&&c.data.push(e)}.bind(this));b(c)},_onDone:function(a,b){(a.onSuccess||$JSKK.emptyFunction)(b)}});$JSKK.Class.create({$namespace:"strappy.data.proxy",$name:"MemoryProxy",$extends:strappy.data.proxy.AbstractProxy})({},{raw:function(a){this.fireEvent("onBeforeRequest",this,a)!==false&&this._onDone(a)},sync:function(a){this.fireEvent("onBeforeRequest",this,a)!==false&&this._onDone(a)},_onDone:function(a){(a.onSuccess||$JSKK.emptyFunction)({})}});$JSKK.Class.create({$namespace:"strappy.data.stateful",$name:"Store",$extends:strappy.data.SingleModelStore})({ACCESS_PRIVATE:"private",ACCESS_PUBLIC:"public",LOCK_NONE:"none",LOCK_READONLY:"readonly",LOCK_FULL:"full"},{events:{onBeforeChange:true,onChange:true,onReady:true},ready:false,readyViews:[],stateMap:{},lockState:"none",keys:[],init:function(){this.model=strappy.mvc.stateful.Model;this.init.$parent();this.mapStateProperties()},mapStateProperties:function(){var a=this.$reflect("self"),b=null;
for(b in this.record.get(a.ACCESS_PRIVATE))this.stateMap[b]=a.ACCESS_PRIVATE;for(b in this.record.get(a.ACCESS_PUBLIC))this.stateMap[b]=a.ACCESS_PUBLIC},canManageStateItem:function(a){return this.stateMap[a]==this.$reflect("self").ACCESS_PUBLIC},set:function(){if(this.lockState==strappy.data.stateful.Store.LOCK_NONE){var a=$JSKK.toArray(arguments),b={},c=null,d=false,e={};Object.isDefined(a[1])?b[a.shift()]=a.shift():b=a.shift();for(var f in b)c=this.stateMap[f],this.record.get(c)[f]!=b[f]&&this.fireEvent("onBeforeChange",
this,f,b[f])!==false&&(this.record.get(c)[f]=b[f],c==this.$reflect("self").ACCESS_PUBLIC&&(d=true,e[f]=b[f]),this.fireEvent("onChange",this,f,b[f]));d&&this.getStateMgr().updateState(e,true)}else throw Error('Store "'+this.$reflect("name")+'" is in lock state "'+this.lockState+'" and so cannot be modified.');return this},setReady:function(a){if(this.ready=a){var a=this.getStateMgr().getState(),b;for(b in a)for(var c in this.state)if(c==b){this.state[c]=a[b];break}this.fireEvent("onReady",this)}return this},
isReady:function(){return this.ready},get:function(a){return this.get.$parent(this.stateMap[a])[a]},setViewReady:function(a){this.readyViews.push(a);return this},getReadyViews:function(){return this.readyViews},lock:function(a){if(["none","readonly","full"].inArray(a))this.lockState=a;else throw Error('"'+a+'" is an invalid lock type. Valid locks are "none", "readonly" and "full".');return this}});$JSKK.Class.create({$namespace:"strappy.mvc",$name:"Controller",$abstract:true,$uses:[strappy.trait.ComponentConnector,strappy.trait.signal.Receive,strappy.trait.signal.Send,$JSKK.trait.Observable]})({},{events:{},init:function(){this.registerSignals({onSignalShow:{signal:strappy.Signal.SHOW,type:"strappy",filter:{iid:this.getIID()}},onSignalHide:{signal:strappy.Signal.HIDE,type:"strappy",filter:{iid:this.getIID()}}})},onReconfigure:$JSKK.emptyFunction,onViewReady:$JSKK.emptyFunction,onGotBaseHTML:$JSKK.emptyFunction,
onReadyState:$JSKK.emptyFunction,onSignalShow:$JSKK.emptyFunction,onSignalHide:$JSKK.emptyFunction});$JSKK.Class.create({$namespace:"strappy.mvc",$name:"Model",$uses:[$JSKK.trait.Observable]})({LOCK_NONE:"none",LOCK_READONLY:"readonly",LOCK_FULL:"full"},{events:{onSync:true,onFailedSync:true,onChange:true,onLockChange:true},dirty:false,phantom:false,_clone:false,idField:"id",fields:[],record:{},store:null,lockState:"none",init:function(a){if(Object.isDefined(a)){this.record=Object.clone(this.fields);for(var b in this.fields)Object.isDefined(a[b])&&(this.record[b]=a[b])}else for(b in this.fields)this.record[b]=
...
this)}.bind(this)}),this.flagClean();else throw Error('The model "'+this.$reflect("namespace")+"."+this.$reflect("name")+'" cannot be synced as it does not have a syncable proxy attached to its bound store.');return this},get:function(a){if(this.lockState==strappy.mvc.Model.LOCK_NONE||this.lockState==strappy.mvc.Model.LOCK_READONLY||this.isClone())return this.record[a];else throw Error('The model "'+this.$reflect("namespace")+"."+this.$reflect("name")+'" is in a lock state that prevents reading.');
},getRecord:function(){if(this.lockState==strappy.mvc.Model.LOCK_NONE||this.lockState==strappy.mvc.Model.LOCK_READONLY||this.isClone())return this.record;else throw Error('The model "'+this.$reflect("namespace")+"."+this.$reflect("name")+'" is in a lock state that prevents reading.');},getId:function(){return Object.isString(this.idField)?this.get(this.idField):null},set:function(){if(this.lockState==strappy.mvc.Model.LOCK_NONE||this.isClone()){var a=$JSKK.toArray(arguments),b={};Object.isDefined(a[1])?
b[a.shift()]=a.shift():b=a.shift();for(var c in b)this.record[c]=b[c];this.flagDirty()}else throw Error('The model "'+this.$reflect("namespace")+"."+this.$reflect("name")+'" is in a lock state that prevents any modification.');this.lockState==strappy.mvc.Model.LOCK_NONE&&!this.isClone()&&this.fireEvent("onChange",this)},flagDirty:function(){this.dirty=true;return this},flagClean:function(){this.dirty=false;return this},isDirty:function(){return this.dirty},isClean:function(){return!this.dirty},lock:function(a,
b){if(["none","readonly","full"].inArray(a))this.lockState=a,b!==true&&!this.isClone()&&this.fireEvent("onLockChange",this,this.lockState);else throw Error('"'+a+'" is an invalid lock type. Valid locks are "none", "readonly" and "full".');return this},clone:function(){var a=new (this.$reflect("self"))({},this.record);a._clone=true;return a},isClone:function(){return this._clone},attachPhantom:function(a){this.phantom=a;return this},hasPhantom:function(){return Boolean(this.phantom)},getPhantom:function(){if(this.hasPhantom())return this.phantom;
else throw Error('The model "'+this.$reflect("namespace")+"."+this.$reflect("name")+'" does not have a phantom model associated with it.');},destroyPhantom:function(){delete this.phantom;this.phantom=null;return this}});$JSKK.Class.create({$namespace:"strappy.mvc",$name:"View",$abstract:true,$uses:[strappy.trait.ComponentConnector,strappy.trait.signal.Bindable,$JSKK.trait.Observable]})({},{events:{onTemplatesLoaded:true,onReady:true,onShow:true,onHide:true},_ready:false,_stateBindings:{},templates:{},element:null,stateStore:null,init:function(){var a=this.getParentComponent();$JSKK.when(a.isConfigured.bind(a)).isTrue(function(){this.fetchTemplateContent(function(){(this.stateStore=this.getStore("State"))&&this.stateStore.observe("onChange",
this.onStateChange.bind(this));this._ready=true;this.onReady();this.fireEvent("onReady",this)}.bind(this))}.bind(this))},fetchTemplateContent:function(a){var b=0,c=0,d;for(d in this.templates)b++;for(d in this.templates){var e=this.$reflect("namespace").replace(/\./g,"/")+"/html/"+this.templates[d];!this.getViewCache().exists(e)||this.getViewCache().isFetching(e)?this.getViewCache().isFetching(e)?$JSKK.when(function(){return this.getViewCache().isFetching(e)}.bind(this)).isFalse(function(a,b){this.templates[b]=
this.getViewCache().get(a);c++}.bind(this,e,d)):(this.getViewCache().setFetching(e),$.get(e,function(a,b,d){this.getViewCache().set(a,d);this.templates[b]=d;c++}.bind(this,e,d))):(this.templates[d]=this.getViewCache().get(e),c++)}$JSKK.when(function(){return b==c}).isTrue(function(){this.fireEvent("onTemplatesLoaded",this);a()}.bind(this))},getTemplate:function(a){return this.templates[a]},onReady:$JSKK.emptyFunction,onViewInit:$JSKK.emptyFunction,onStoreChange:$JSKK.emptyFunction,syncView:$JSKK.Class.ABSTRACT_METHOD,
bindDOMEvents:$JSKK.Class.ABSTRACT_METHOD,getContainerClass:function(){return"."+this.getSafeID()},getContainer:function(){return $("#"+this.getIID())},show:function(){this.getContainer().show();this.fireEvent("onShow",this);return this},hide:function(){this.getContainer().hide();this.fireEvent("onHide",this);return this},bindContainerEvent:function(a,b,c,d){return this.bindDOMEvent(a,null,b,c,d)},bindDOMEvent:function(a,b,c,d,e){var f=c.split(":");if(f.length==2)switch(f[0]){case "controller":f=
this.getController(f[1]);break;case "view":f=this}else f=this.getController(c);if(Object.isArray(b))$(b[0],this.getContainer()).on(a,b[1],e,f[d].bind(f));else this.getContainer().on(a,b,e,f[d].bind(f));return this},bindBodyDOMEvent:function(a,b,c,d,e){var f=c.split(":");if(f.length==2)switch(f[0]){case "controller":f=this.getController(f[1]);break;case "view":f=this}else f=this.getController(c);$("body").on(a,b,e,f[d].bind(f));return this}});$JSKK.Class.create({$namespace:"strappy.mvc",$name:"ViewCache"})({FETCHING:"~*~FETCHING~*~"},{cache:{},set:function(a,b){this[String(a)]=String(b);return this},get:function(a){return this[String(a)]||""},exists:function(a){return Object.isDefined(this[String(a)])},setFetching:function(a){this[String(a)]=strappy.mvc.ViewCache.FETCHING;return this},isFetching:function(a){return this[String(a)]===strappy.mvc.ViewCache.FETCHING}});$JSKK.Class.create({$namespace:"strappy.mvc.stateful",$name:"Controller",$abstract:true,$uses:[strappy.trait.ComponentConnector,strappy.trait.signal.Receive,strappy.trait.signal.Send,strappy.trait.signal.Bindable,$JSKK.trait.Observable]})({},{events:{onBeforeReadyState:true,onReadyState:true},stateStore:null,onBeforeChange:$JSKK.Class.ABSTRACT_METHOD,init:function(){this.registerSignals({onStateChangeFromStateMgr:strappy.Signal.STATE_CHANGE});if(!(this.stateStore=this.getStore("State")))throw Error('Unable to initialize "'+
...
true)}}}},onViewReady:$JSKK.emptyFunction,setReady:function(){this.stateStore.setReady(true);if(this.fireEvent("onBeforeReadyState",this,true)!==false){var a=this.getStateMgr().getState(),b;for(b in a)if(this.stateStore.canManageStateItem(b)){var c=this.stateStore.get(b);if(!this.stateStore.set(b,a[b])){var d={};d[b]=c;this.getStateMgr().updateState(d,true)}}this.fireEvent("onReadyState",this,true)}return this},updateState:function(){this.stateStore.set(key,value);this.stateStore.set.apply(this.stateStore,
$JSKK.toArray(arguments));return this},setViewReadyState:function(a){this.stateStore.setViewReady(a);return this},getReadyViews:function(){return this.stateStore.getReadyViews()}});$JSKK.Class.create({$namespace:"strappy.mvc.stateful",$name:"Model",$extends:strappy.mvc.Model})({},{fields:{"private":{},"public":{}}});$JSKK.Trait.create({$namespace:"strappy.trait",$name:"ComponentConnector"})({init:function(a){this._component=a},getParentComponent:function(){return this._component},getCmpName:function(){return this.getParentComponent().my.name},getRadioTower:function(){return this.getParentComponent().radioTower},getStateMgr:function(){return this.getParentComponent().stateMgr},getID:function(){return this.$reflect("namespace")+"."+this.$reflect("name")},getSafeID:function(){return this.getParentComponent().getSafeID(cmp)},
