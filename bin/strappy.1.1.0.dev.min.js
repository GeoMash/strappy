$JSKK.Trait.create({$namespace:"strappy.trait",$name:"ComponentConnector"})({init:function(a){this._component=a},getParentComponent:function(){return this._component},getCmpName:function(){return this.getParentComponent().my.name},getRadioTower:function(){return this.getParentComponent().radioTower},getStateMgr:function(){return this.getParentComponent().stateMgr},getID:function(){return this.$reflect("namespace")+"."+this.$reflect("name")},getSafeID:function(){return this.getParentComponent().getSafeID(cmp)},
...
this.BTL=a.handler;this.BTL_GET=a.get;this.BTL_SET=a.set;return this}});$JSKK.Class.create({$namespace:"strappy.data",$name:"Transaction"})({STATE_INIT:0,STATE_STARTED:1,STATE_COMITTED:2,STATE_COMPLETE:4,STATE_SUCCESS:8,STATE_FAILED:16,STATE_ROLLEDBACK:32},{models:[],queue:false,state:0,lockState:"full",init:function(a){if(a!==false)this.queue=new strappy.data.Queue},attachModel:function(a){if(Object.isDefined(a)&&Object.isFunction(a.$reflect)&&a.$reflect("extends")==strappy.mvc.Model){var b=a.getStore();b&&b.informModelIsInTransaction(a,this);a.lock(this.lockState);
...
else throw Error('The model "'+this.$reflect("namespace")+"."+this.$reflect("name")+'" does not have a phantom model associated with it.');},destroyPhantom:function(){delete this.phantom;this.phantom=null;return this}});$JSKK.Class.create({$namespace:"strappy.mvc",$name:"ViewCache"})({FETCHING:"~*~FETCHING~*~"},{cache:{},set:function(a,b){this[String(a)]=String(b);return this},get:function(a){return this[String(a)]||""},exists:function(a){return Object.isDefined(this[String(a)])},setFetching:function(a){this[String(a)]=strappy.mvc.ViewCache.FETCHING;return this},isFetching:function(a){return this[String(a)]===strappy.mvc.ViewCache.FETCHING}});$JSKK.Class.create({$namespace:"strappy.mvc",$name:"View",$abstract:true,$uses:[strappy.trait.ComponentConnector,strappy.trait.signal.Bindable,$JSKK.trait.Observable]})({},{events:{onTemplatesLoaded:true,onReady:true,onShow:true,onHide:true},_ready:false,_stateBindings:{},templates:{},element:null,stateStore:null,init:function(){var a=this.getParentComponent();$JSKK.when(a.isConfigured.bind(a)).isTrue(function(){this.fetchTemplateContent(function(){(this.stateStore=this.getStore("State"))&&this.stateStore.observe("onChange",
...
$JSKK.toArray(arguments));return this},setViewReadyState:function(a){this.stateStore.setViewReady(a);return this},getReadyViews:function(){return this.stateStore.getReadyViews()}});$JSKK.Class.create({$namespace:"strappy.mvc.stateful",$name:"Model",$extends:strappy.mvc.Model})({},{fields:{"private":{},"public":{}}});$JSKK.Class.create({$namespace:"strappy",$name:"RadioTower",$uses:[$JSKK.trait.Observable]})({},{events:{}});$JSKK.Class.create({$namespace:"strappy",$name:"InitQueue",$uses:[$JSKK.trait.Observable]})({},{events:{onItemReady:true,onAllReady:true},items:[],processPointer:-1,length:0,complete:0,add:function(a,b,c,d){this.items.push({name:a,ref:b,config:c,callback:d||$JSKK.emptyFunction});this.length++;return this},execute:function(){$JSKK.when(this,{object:"complete",value:this.length}).isEqualTo(function(){this.fireEvent("onAllReady",this.items)}.bind(this));this.processNextItem()},processNextItem:function(){this.processPointer++;
...
this.className+" attempted to fire an empty signal.");else $JSKK.when(this,"radioTower").isAssocArray(function(){this.radioTower.fireEvent(a,new strappy.Signal({name:a,body:d,type:b,filter:c}))}.bind(this))}});$JSKK.Class.create("Strappy")({VERSION:"1.0.0-beta",VERSION_MAJOR:1,VERSION_MINOR:0,VERSION_MICRO:0,VERSION_STAGE:"beta",VERSION_STAGE_NUM:0},{});
