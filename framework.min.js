...
lock:function(a){if(["none","readonly","full"].inArray(a))this.lockState=a;else throw Error('"'+a+'" is an invalid lock type. Valid locks are "none", "readonly" and "full".');return this}});$JSKK.Class.create({$namespace:"framework.mvc",$name:"Model",$uses:[$JSKK.trait.Observable]})({LOCK_NONE:"none",LOCK_READONLY:"readonly",LOCK_FULL:"full"},{events:{onSync:true,onFailedSync:true,onChange:true,onLockChange:true},dirty:false,phantom:false,_clone:false,idField:"id",fields:[],record:{},store:null,lockState:"none",init:function(a){if(Object.isDefined(a)){this.record=Object.clone(this.fields);for(var b in this.fields)Object.isDefined(a[b])&&(this.record[b]=a[b])}else for(b in this.fields)this.record[b]=
