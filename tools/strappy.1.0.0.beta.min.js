...
this.BTL=a.handler;this.BTL_GET=a.get;this.BTL_SET=a.set;return this}});$JSKK.Class.create({$namespace:"framework.data",$name:"Transaction"})({STATE_INIT:0,STATE_STARTED:1,STATE_COMITTED:2,STATE_COMPLETE:4,STATE_SUCCESS:8,STATE_FAILED:16,STATE_ROLLEDBACK:32},{models:[],queue:false,state:0,lockState:"full",init:function(a){if(a!==false)this.queue=new framework.data.Queue},attachModel:function(a){if(Object.isDefined(a)&&Object.isFunction(a.$reflect)&&a.$reflect("extends")==framework.mvc.Model){var b=a.getStore();b&&b.informModelIsInTransaction(a,this);a.lock(this.lockState);
...
getPhantom:function(){if(this.hasPhantom())return this.phantom;else throw Error('The model "'+this.$reflect("namespace")+"."+this.$reflect("name")+'" does not have a phantom model associated with it.');},destroyPhantom:function(){delete this.phantom;this.phantom=null;return this}});$JSKK.Class.create({$namespace:"framework.mvc",$name:"ViewCache"})({FETCHING:"~*~FETCHING~*~"},{cache:{},set:function(a,b){this[String(a)]=String(b);return this},get:function(a){return this[String(a)]||""},exists:function(a){return Object.isDefined(this[String(a)])},setFetching:function(a){this[String(a)]=framework.mvc.ViewCache.FETCHING;return this},isFetching:function(a){return this[String(a)]===framework.mvc.ViewCache.FETCHING}});$JSKK.Class.create({$namespace:"framework.mvc",$name:"View",$abstract:true,$uses:[framework.trait.ComponentConnector,framework.trait.signal.Bindable,$JSKK.trait.Observable]})({},{events:{onTemplatesLoaded:true,onReady:true,onShow:true,onHide:true},_ready:false,_stateBindings:{},templates:{},element:null,stateStore:null,init:function(){var a=this.getParentComponent();$JSKK.when(a.isConfigured.bind(a)).isTrue(function(){this.fetchTemplateContent(function(){(this.stateStore=this.getStore("State"))&&
...
else $JSKK.when(this,"radioTower").isAssocArray(function(){this.radioTower.fireEvent(a,new framework.Signal({name:a,body:d,type:b,filter:c}))}.bind(this))}});
