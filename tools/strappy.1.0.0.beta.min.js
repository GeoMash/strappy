...
else $JSKK.when(this,"radioTower").isAssocArray(function(){this.radioTower.fireEvent(a,new strappy.Signal({name:a,body:d,type:b,filter:c}))}.bind(this))}});$JSKK.Class.create("Strappy")({VERSION:"1.0.0-beta",VERSION_MAJOR:1,VERSION_MINOR:0,VERSION_MICRO:0,VERSION_STAGE:"beta",VERSION_STAGE_NUM:0},{});
